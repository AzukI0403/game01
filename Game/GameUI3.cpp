...
void GameUI3::Update()
{
	...
	//Update()を抜け出す処理の判定。
	//game3またはgame_finalがGameOverFlagがtrueなら抜け出す。
		switch (stagenumber)
		{
		case 3:
		...
		case 4:
			//game_final->GameOverFlagがtrueなら抜け出す。
		...
		//boss03のインスタンスを見つけたかつboss03が倒されていないなら。
...
void GameUI3::Render(RenderContext& rc)
{
	...
	//boss02のインスタンスを見つけたかつboss02が倒されていないならHPバーを描く。
