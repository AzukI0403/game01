...
# 5.enemy紹介
### 5.1　1-1のボス　　
１－１のボスの行動は３つあります。１つ目は、拡散弾で複数の弾をランダムな場所に発射します。２つ目は追尾弾、３つ目はかみつき攻撃です。ボスからプレイヤーに向かうベクトルを計算し、ベクトルを正規化し16倍してボスを移動させています。
### 5.2　1-2のボス
１－２のボスの行動は３つあります。１つ目は、ボス３体のランダムで１体が弾を前方に打つのを何度か繰り返します。２つ目は、追尾弾です。ボスの上２体は
### 5.3　1-3のボス
...
![screen](UNIVESEPILOT/screenchange.png)